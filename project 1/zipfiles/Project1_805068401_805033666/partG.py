...
def plot_roc(fpr, tpr, penalty):
	...
	plt.title("ROC curve for Logistic Regression Classifier with no regualarization")
	ax.set_xlim([-0.1, 1.1])
...
def plot_confusion_matrix(cm, classes,
    ...
    plt.savefig("LR"+str(normalize) +  ".png")
...
lr_norm2 = linear_model.LogisticRegression(C = 10000000000)
...
print_statistics(test_target_group, lr_predicted)
fpr, tpr, _ = roc_curve(test_target_group, lrPredictedProbs[:,1])
plot_roc(fpr,tpr, penalty=0.0001)
