...
mnb_predicted = mnb_clf.predict(test_nmf)
nmb_predicted_probs = mnb_clf.predict_proba(test_nmf)
print_statistics(test_target_group, mnb_predicted)

cnf_matrix = smet.confusion_matrix(test_target_group, mnb_predicted)
plot_confusion_matrix(cnf_matrix, classes=classCategories, title='Confusion matrix for Multiclass NB Classifier')
