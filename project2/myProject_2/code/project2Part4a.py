...
x1 = totalNMF[kmeans.labels_ == 0][:, 0]
y1 = totalNMF[kmeans.labels_ == 0][:, 1]

plt.plot(x1,y1,'r+', label='Computer Technology')
x2 = totalNMF[kmeans.labels_ == 1][:, 0]
y2 = totalNMF[kmeans.labels_ == 1][:, 1]
...
plt.savefig("clusters_2dNMF.png", format='png')
